...
function getSectionClass(theme: string | undefined) {
  return theme === "dark"
    ? "bg-destructive text-secondary px-4 sm:px-8 py-12 sm:py-16"
    : "bg-accent px-4 sm:px-8 py-12 sm:py-16";
}
  ...
  return (
    <section className={`${getSectionClass(theme)} relative`}>
      ...
      <div className="mx-auto max-w-4xl text-center mb-8 sm:mb-12 relative z-10">
        ...
        <p className="mt-2 px-4 text-sm sm:text-base font-sans">
            ...
            {TESTIMONIALS.map((testimonial, index) => (
              ...
              >
                <div className="flex flex-col items-center space-y-4 text-center">
                  ...
                  />
                  <div
                    className={`mx-auto w-4/5 text-sm sm:text-base lg:text-lg ${getTextClass(theme)}`}
                  >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="block text-base sm:text-lg font-semibold tracking-tight lg:text-xl">
                      {testimonial.name}
                    </span>
