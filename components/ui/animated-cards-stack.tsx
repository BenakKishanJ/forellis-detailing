...
export const CardsContainer: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative flex items-center justify-center pt-8 sm:pt-12",
        className,
      )}
...
>(
  (
    ...
    const dy = useTransform(scrollYProgress, rotateRange, [2, 8]);
    const blur = useTransform(scrollYProgress, rotateRange, [1, 16]);
